...
import { ViewDetailDevice } from './view';

interface IComponentDetailDevice {
  api: IApiRequest;
}
...
const ComponentDetailDevice: FunctionComponent<IComponentDetailDevice> = props => {
  const { api } = props;
